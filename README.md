...
- **Driver** It contains a connection, sets and reads the voltage, and translates the error codes returned by the device into Python exceptions.
- **Connection** contains the device. It carries the commands from the driver to the device and returns its answer.
